                    ...
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton asChild>
                        <button
                          ...
                          className={`flex cursor-pointer items-center gap-2 px-2 py-2 rounded-md hover:bg-copper/10 transition-all duration-300 w-full ${
                            isLocked ? "opacity-80" : ""
                          }`}
                          title={
                            isLocked
        ...
        <SidebarFooter className="border-t border-copper/30 pt-4 mt-auto transition-colors duration-300">
          <div
            className={`flex flex-col space-y-4 ${
              state === "expanded" || isMobile ? "px-3" : "px-1 items-center"
            }`}
          >
            {/* Theme Toggle */}
            <div
            ...
            >
              ...
              <div
                className={`flex items-center ${state === "expanded" || isMobile ? "gap-2" : ""}`}
              >
